...
def summary_document_to_markdown(doc: SummaryDocument) -> str:
...
def summary_document_from_markdown(markdown: str) -> SummaryDocument:
    from .models import SummaryDocument
    ...
    key_points_lines = extract_section("Key Points")
    key_points: list[str] = []
