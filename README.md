...
- Optimized for **small local models (SLMs)**, which are often sufficient for high-quality summarization.
...
> [!NOTE]
> Small local models are a great default for most summarization tasks.
